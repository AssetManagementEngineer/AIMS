! function(e, t) {
    ...
    return function(e) {
        ...
        class i {
            ...
            // This is where I could add the interface content
            contextmenu(e) {
            ...
            drawConnection(e) {
                ...
                var idx = s.split('_')[1];
                if(idx>1){
                    n.style="stroke:#ff0000;";//red
                }else if(idx>2){
                    n.style="stroke:#f2bb13;";//yellow
                }else{
                    n.style="stroke:#008800;";//green
                }
            ...
            addNodeImport(e, t) {
                ...
                o.classList.add("outputs"), Object.keys(e.inputs).map((function(n, i) {
                    ...
                    o.classList.add("input"), o.classList.add(n), s.appendChild(o), Object.keys(e.inputs[n].connections).map((function(i, s) {
                        ...
                        var idx = n.split('_')[1];
                        if(idx>1){
                            l.style="stroke:#ff0000;";//Red
                        }else if(idx>2){
                            l.style="stroke:#f2bb13;";//yellow
                        }else{
                            l.style="stroke:#008800;";//Green
                        }
